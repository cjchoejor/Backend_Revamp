...
// Capacity is intentionally absent: occupancy belongs to the room TYPE
// (Room types -> standard / max capacity), which is what the backend actually enforces.
// A per-room capacity field existed here but nothing ever read it.
