...
export type TravelAgentAdmin = {
  id: string;
  displayName: string;
  /** An agency usually has several (office, owner, WhatsApp); the single column lost the rest. */
...
// Rate cards were replaced by RatePackage on 2026-08-04 — see listRatePackages above.
