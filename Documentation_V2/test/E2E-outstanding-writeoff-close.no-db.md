...
- **Ran at**: 2026-04-27T11:17:01.390Z
- **Base URL**: `http://localhost:4000/api`
- **Entry ID**: `69464aa7-77a8-43c8-a5a9-43045be29b95`
- **Inquiry ID**: `9e7f7f73-4369-402d-a07e-044c452087ce`
- **GuestProfile ID (seeded)**: `9b33e663-9a0a-4d0f-a7e1-85c0235453d5`

## Steps

### S1 create inquiry

- **Request**: `POST` `/inquiries` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/availability/search` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/availability/configurations/33c9a4c9-9bfa-4bed-9a39-2fc952aaf73d/select` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/progress-stage` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/quotations` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/quotations/2a81c83c-b97f-4ac4-962d-fcf5f7acd71e/send` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/quotations/2a81c83c-b97f-4ac4-962d-fcf5f7acd71e/accept` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/folio/provisional` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/folios/0cc4599e-394f-4c13-b309-b80de96122c8/payments` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/folios/0cc4599e-394f-4c13-b309-b80de96122c8/advance-payment/reconcile` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/disclosures/cancellation` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/holds/committed` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/confirm` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/pre-arrival-tasks/3d8fc984-2ca5-455a-b270-9224ee13695e` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/pre-arrival-tasks/0ecbc305-2267-4bdf-88e7-6b97705ec2b7` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/pre-arrival-tasks/0a740c96-173d-4a9c-a26d-9bc308cdc72b` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/pre-arrival-tasks/e02d0789-17ef-417d-8b20-80bf8231ce0c` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/pre-arrival-tasks/49f38efd-46a9-4390-9f1d-7bf2d65b4778` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/pre-arrival-tasks/a81deeb1-bdb2-43f1-b75a-7c74e63d61eb` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/pre-arrival-tasks/6de56af1-53ea-453b-b6de-6b65b30d89a5` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `PATCH` `/pre-arrival-tasks/ba8b1d44-7cac-48a2-9fb4-18f4017fee65` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/room-assignments` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/handoffs/2ebd9e76-73b4-47d9-bc71-57d9566b8b92/accept` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/handoffs/2ebd9e76-73b4-47d9-bc71-57d9566b8b92/fulfil` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/handoffs/h2` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/guest-profiles/9b33e663-9a0a-4d0f-a7e1-85c0235453d5/verify-identity` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/night-audit/run` (actor `L2` / `e2e-fom-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/handoffs/h4` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/key-return` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/room-inspection` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/handoffs/a0e3672b-7223-4cd3-82f4-a7b0bfaff5cb/fulfil` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/folios/0cc4599e-394f-4c13-b309-b80de96122c8/settle` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/handoffs/5cee1237-3784-4b8a-96df-708a05b6fb01/fulfil` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/folios/0cc4599e-394f-4c13-b309-b80de96122c8/write-off` (actor `L3` / `e2e-gm-8`)
...
- **Request**: `GET` `/folios/0cc4599e-394f-4c13-b309-b80de96122c8/invoices` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/invoices/5baa054f-eefe-4ce6-9ecf-180612ea8260/dispatch` (actor `L1` / `e2e-fd-8`)
...
- **Request**: `POST` `/entries/69464aa7-77a8-43c8-a5a9-43045be29b95/close` (actor `L2` / `e2e-fom-8`)
