...
- **Source report**: `Documentation_V2/test/E2E-direct-bill-s1-to-s9-test-report.no-db.md`
- **Scenario title**: E2E direct-bill flow report (S1 → S9)
- **Goal**: Validate DIRECT_BILL billing model flow through S9 closure.
...
- **Goal**: Execute `PATCH` `/availability/configurations/c1323e7f-e7b3-4197-acd6-4724bd5e86c7/select` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/availability/configurations/c1323e7f-e7b3-4197-acd6-4724bd5e86c7/select",
  "body": {
    "roomId": "af1318b9-c409-4434-bb01-aee51cacaf6f"
  }
}
...
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/progress-stage` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/progress-stage",
  "body": {
    "targetStage": "S2",
    "version": 1
  }
...
### S2 create quotation
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/quotations` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/quotations",
  "body": {
    "nightlyRate": 100,
    "currency": "BTN",
    "notes": "e2e quotation"
...
### S2 send quotation
- **Goal**: Execute `POST` `/quotations/c455ef25-4cf2-49ec-8c40-de38aeebf41d/send` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/quotations/c455ef25-4cf2-49ec-8c40-de38aeebf41d/send",
  "body": {
    "id": "c455ef25-4cf2-49ec-8c40-de38aeebf41d",
    "entryId": "7a02c505-9743-4106-95b3-8fa48234310b",
    "segmentId": "db49f0ac-933c-4c2c-b588-52fded95f9fb",
...
### S2 accept quotation
- **Goal**: Execute `POST` `/quotations/c455ef25-4cf2-49ec-8c40-de38aeebf41d/accept` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/quotations/c455ef25-4cf2-49ec-8c40-de38aeebf41d/accept",
  "body": {
    "id": "c455ef25-4cf2-49ec-8c40-de38aeebf41d",
    "entryId": "7a02c505-9743-4106-95b3-8fa48234310b",
    "segmentId": "db49f0ac-933c-4c2c-b588-52fded95f9fb",
...
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/folio/provisional` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/folio/provisional",
  "body": {
...
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/credit-extension` and advance scenario state.
- **Request**: actor `L2`/`e2e-fom-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/credit-extension",
  "body": {
...
- **Goal**: Execute `POST` `/folios/71c80d12-140c-4c72-85a0-c6dd1b752885/advance-payment/reconcile` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/folios/71c80d12-140c-4c72-85a0-c6dd1b752885/advance-payment/reconcile",
  "body": {
    "entryId": "7a02c505-9743-4106-95b3-8fa48234310b",
...
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/disclosures/cancellation` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/disclosures/cancellation",
  "body": {
...
### S3 committed hold
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/holds/committed` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/holds/committed",
  "body": {
    "roomId": "af1318b9-c409-4434-bb01-aee51cacaf6f",
...
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/confirm` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/confirm",
  "body": {
    "version": 3
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/5b2df2ae-41e5-4e19-847c-ddc32a332063` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/5b2df2ae-41e5-4e19-847c-ddc32a332063",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/7441f6cb-82bd-441f-9527-db4590cfff21` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/7441f6cb-82bd-441f-9527-db4590cfff21",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/cd420f53-e605-4ce0-a543-09e44cb0b20f` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/cd420f53-e605-4ce0-a543-09e44cb0b20f",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/214a1aee-97a0-43c6-a8b0-a71ef0671007` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/214a1aee-97a0-43c6-a8b0-a71ef0671007",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/1b6038d8-a35c-4a8c-b19d-75aca6d04372` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/1b6038d8-a35c-4a8c-b19d-75aca6d04372",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/eff16911-c347-4246-8b66-d1674ad279e7` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/eff16911-c347-4246-8b66-d1674ad279e7",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/dedb94a4-d222-4ac7-a376-6106124f2246` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/dedb94a4-d222-4ac7-a376-6106124f2246",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/d7eb1b97-9c02-4511-a650-1f5900f1c99f` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/d7eb1b97-9c02-4511-a650-1f5900f1c99f",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/d42eef3d-4751-400c-a706-6901e3fe24c1` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/d42eef3d-4751-400c-a706-6901e3fe24c1",
  "body": {
    "action": "COMPLETE"
  }
}
...
### S5 room assignment
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/room-assignments` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/room-assignments",
  "body": {
    "roomId": "af1318b9-c409-4434-bb01-aee51cacaf6f",
    "notes": "e2e assign"
  }
...
### S5 accept H1
- **Goal**: Execute `POST` `/handoffs/1d805176-e1f5-4579-8e87-7880b9876a25/accept` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/handoffs/1d805176-e1f5-4579-8e87-7880b9876a25/accept",
  "body": {
    "checklistCompletion": {
...
### S5 fulfil H1
- **Goal**: Execute `POST` `/handoffs/1d805176-e1f5-4579-8e87-7880b9876a25/fulfil` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/handoffs/1d805176-e1f5-4579-8e87-7880b9876a25/fulfil",
  "body": {
    "fulfilmentEvidence": {
...
### S6 create H2
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/handoffs/h2` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/handoffs/h2",
  "body": {
    "roomNumber": "401",
    "guestProfileId": "06ccf167-0619-4686-b1bc-ad5cb463dcb9",
    "deficientConditionStatus": null
...
- **Goal**: Execute `POST` `/guest-profiles/06ccf167-0619-4686-b1bc-ad5cb463dcb9/verify-identity` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/guest-profiles/06ccf167-0619-4686-b1bc-ad5cb463dcb9/verify-identity",
  "body": {
    "entryId": "7a02c505-9743-4106-95b3-8fa48234310b",
...
### S7 initiate H4
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/handoffs/h4` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/handoffs/h4",
  "body": {
...
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/key-return` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/key-return",
  "body": {
    "keyCountReturned": 2
  }
}
...
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/room-inspection` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/room-inspection",
  "body": {
    "isDeferred": false,
...
### S8 fulfil H4
- **Goal**: Execute `POST` `/handoffs/4f2daf0f-8c94-43c9-bec2-1d58cfad9073/fulfil` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/handoffs/4f2daf0f-8c94-43c9-bec2-1d58cfad9073/fulfil",
  "body": {
    "fulfilmentEvidence": {
...
- **Goal**: Execute `POST` `/folios/71c80d12-140c-4c72-85a0-c6dd1b752885/settle` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/folios/71c80d12-140c-4c72-85a0-c6dd1b752885/settle",
  "body": {
...
### S9 fulfil H5
- **Goal**: Execute `POST` `/handoffs/43e61009-fab0-4770-9d4b-e62b78dd24b5/fulfil` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/handoffs/43e61009-fab0-4770-9d4b-e62b78dd24b5/fulfil",
  "body": {
    "fulfilmentEvidence": {
...
### S9 list invoices
- **Goal**: Execute `GET` `/folios/71c80d12-140c-4c72-85a0-c6dd1b752885/invoices` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "GET",
  "path": "/folios/71c80d12-140c-4c72-85a0-c6dd1b752885/invoices",
  "body": [
    {
...
- **Goal**: Execute `POST` `/invoices/75d929f7-eea9-4d92-b882-86609451ddcc/dispatch` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-2`

```json
{
  "method": "POST",
  "path": "/invoices/75d929f7-eea9-4d92-b882-86609451ddcc/dispatch",
  "body": {
...
### S9 close entry
- **Goal**: Execute `POST` `/entries/7a02c505-9743-4106-95b3-8fa48234310b/close` and advance scenario state.
- **Request**: actor `L2`/`e2e-fom-2`

```json
{
  "method": "POST",
  "path": "/entries/7a02c505-9743-4106-95b3-8fa48234310b/close",
  "body": {
    "id": "7a02c505-9743-4106-95b3-8fa48234310b",
    "inquiryId": "2b82882b-1694-4767-bff0-ee54dff9aeaa",
    "guestProfileId": "06ccf167-0619-4686-b1bc-ad5cb463dcb9",
