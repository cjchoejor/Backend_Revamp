...
- **Source report**: `Documentation_V2/test/E2E-voucher-s1-to-s9-test-report.no-db.md`
- **Scenario title**: E2E voucher flow report (S1 → S9) — no DB diffs
- **Goal**: Validate VOUCHER settlement (partial coverage) leading to OUTSTANDING + H5 + closure.
...
- **Goal**: Execute `PATCH` `/availability/configurations/6d0af195-f779-4405-a27e-c90d7cddd90d/select` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/availability/configurations/6d0af195-f779-4405-a27e-c90d7cddd90d/select",
  "body": {
    "roomId": "543cedc6-de06-4aae-94c3-86958649373a"
  }
}
...
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/progress-stage` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/progress-stage",
  "body": {
    "targetStage": "S2",
    "version": 1
  }
...
### S2 create quotation
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/quotations` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/quotations",
  "body": {
    "nightlyRate": 100,
    "currency": "BTN",
    "notes": "e2e quotation"
...
### S2 send quotation
- **Goal**: Execute `POST` `/quotations/28e459e3-676c-479b-b95e-3b35a99f39a1/send` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/quotations/28e459e3-676c-479b-b95e-3b35a99f39a1/send",
  "body": {
    "id": "28e459e3-676c-479b-b95e-3b35a99f39a1",
    "entryId": "de712465-3f84-467b-a3b7-dc68fe97feb4",
    "segmentId": "93dc52a1-4b28-4477-ae2b-d299bcfc2a84",
...
### S2 accept quotation
- **Goal**: Execute `POST` `/quotations/28e459e3-676c-479b-b95e-3b35a99f39a1/accept` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/quotations/28e459e3-676c-479b-b95e-3b35a99f39a1/accept",
  "body": {
    "id": "28e459e3-676c-479b-b95e-3b35a99f39a1",
    "entryId": "de712465-3f84-467b-a3b7-dc68fe97feb4",
    "segmentId": "93dc52a1-4b28-4477-ae2b-d299bcfc2a84",
...
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/folio/provisional` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/folio/provisional",
  "body": {
...
- **Goal**: Execute `POST` `/folios/cf389fde-4232-4676-9d0a-385cb0775c04/payments` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/folios/cf389fde-4232-4676-9d0a-385cb0775c04/payments",
  "body": {
    "entryId": "de712465-3f84-467b-a3b7-dc68fe97feb4",
    "amount": 1000,
...
- **Goal**: Execute `POST` `/folios/cf389fde-4232-4676-9d0a-385cb0775c04/advance-payment/reconcile` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/folios/cf389fde-4232-4676-9d0a-385cb0775c04/advance-payment/reconcile",
  "body": {
    "entryId": "de712465-3f84-467b-a3b7-dc68fe97feb4",
    "note": "e2e reconcile"
  }
...
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/disclosures/cancellation` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/disclosures/cancellation",
  "body": {
...
### S3 committed hold
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/holds/committed` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/holds/committed",
  "body": {
    "roomId": "543cedc6-de06-4aae-94c3-86958649373a",
...
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/confirm` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/confirm",
  "body": {
    "version": 3
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/29e5674f-8411-4bb4-ac10-a3f2f8e50cef` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/29e5674f-8411-4bb4-ac10-a3f2f8e50cef",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/94e48db5-0c2a-47d5-a0b9-296f1ae6d94a` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/94e48db5-0c2a-47d5-a0b9-296f1ae6d94a",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/d195995b-fb66-4a02-a5ec-a2ecb439ca61` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/d195995b-fb66-4a02-a5ec-a2ecb439ca61",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/09e23b78-bf5b-49fc-9ab4-895df73bae6d` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/09e23b78-bf5b-49fc-9ab4-895df73bae6d",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/169c5bc2-ce59-4066-832d-10ad010a9026` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/169c5bc2-ce59-4066-832d-10ad010a9026",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/d3bec406-b436-4de4-8f24-b5974de23ba5` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/d3bec406-b436-4de4-8f24-b5974de23ba5",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/4d1cdeb1-9a1a-4944-b965-31899c886a52` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/4d1cdeb1-9a1a-4944-b965-31899c886a52",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/ec42b9e6-9759-4ab2-8b47-186c71416f9a` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/ec42b9e6-9759-4ab2-8b47-186c71416f9a",
  "body": {
    "action": "COMPLETE"
  }
}
...
### S5 room assignment
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/room-assignments` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/room-assignments",
  "body": {
    "roomId": "543cedc6-de06-4aae-94c3-86958649373a",
    "notes": "e2e assign"
  }
...
### S5 accept H1
- **Goal**: Execute `POST` `/handoffs/948b36a4-fed7-4383-87bc-877313adb574/accept` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/handoffs/948b36a4-fed7-4383-87bc-877313adb574/accept",
  "body": {
    "checklistCompletion": {
...
### S5 fulfil H1
- **Goal**: Execute `POST` `/handoffs/948b36a4-fed7-4383-87bc-877313adb574/fulfil` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/handoffs/948b36a4-fed7-4383-87bc-877313adb574/fulfil",
  "body": {
    "fulfilmentEvidence": {
...
### S6 create H2
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/handoffs/h2` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/handoffs/h2",
  "body": {
    "roomNumber": "401",
    "guestProfileId": "812fbd7a-2693-4a67-af23-6d315bbdef80",
    "deficientConditionStatus": null
...
- **Goal**: Execute `POST` `/guest-profiles/812fbd7a-2693-4a67-af23-6d315bbdef80/verify-identity` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/guest-profiles/812fbd7a-2693-4a67-af23-6d315bbdef80/verify-identity",
  "body": {
    "entryId": "de712465-3f84-467b-a3b7-dc68fe97feb4",
...
- **Goal**: Execute `POST` `/folios/cf389fde-4232-4676-9d0a-385cb0775c04/charges` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/folios/cf389fde-4232-4676-9d0a-385cb0775c04/charges",
  "body": {
    "entryId": "de712465-3f84-467b-a3b7-dc68fe97feb4",
    "lineType": "F_AND_B",
...
### S7 initiate H4
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/handoffs/h4` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/handoffs/h4",
  "body": {
...
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/key-return` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/key-return",
  "body": {
    "keyCountReturned": 2
  }
}
...
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/room-inspection` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/room-inspection",
  "body": {
    "isDeferred": false,
...
### S8 fulfil H4
- **Goal**: Execute `POST` `/handoffs/05ff18e5-63fb-4106-9c41-351dcdbccc55/fulfil` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/handoffs/05ff18e5-63fb-4106-9c41-351dcdbccc55/fulfil",
  "body": {
    "fulfilmentEvidence": {
...
### S8 get folio
- **Goal**: Execute `GET` `/folios/cf389fde-4232-4676-9d0a-385cb0775c04` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "GET",
  "path": "/folios/cf389fde-4232-4676-9d0a-385cb0775c04",
  "body": {
    "id": "cf389fde-4232-4676-9d0a-385cb0775c04",
    "entryId": "de712465-3f84-467b-a3b7-dc68fe97feb4",
    "state": "LIVE",
...
- **Goal**: Execute `POST` `/folios/cf389fde-4232-4676-9d0a-385cb0775c04/settle` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/folios/cf389fde-4232-4676-9d0a-385cb0775c04/settle",
  "body": {
...
### S9 fulfil H5
- **Goal**: Execute `POST` `/handoffs/0415875c-8460-489f-896c-98810c9eda0e/fulfil` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/handoffs/0415875c-8460-489f-896c-98810c9eda0e/fulfil",
  "body": {
    "fulfilmentEvidence": {
...
### S9 list invoices
- **Goal**: Execute `GET` `/folios/cf389fde-4232-4676-9d0a-385cb0775c04/invoices` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "GET",
  "path": "/folios/cf389fde-4232-4676-9d0a-385cb0775c04/invoices",
  "body": [
    {
...
- **Goal**: Execute `POST` `/invoices/de127dec-737a-4111-aa35-fb95b7aa5729/dispatch` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-3`

```json
{
  "method": "POST",
  "path": "/invoices/de127dec-737a-4111-aa35-fb95b7aa5729/dispatch",
  "body": {
...
### S9 close entry
- **Goal**: Execute `POST` `/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/close` and advance scenario state.
- **Request**: actor `L2`/`e2e-fom-3`

```json
{
  "method": "POST",
  "path": "/entries/de712465-3f84-467b-a3b7-dc68fe97feb4/close",
  "body": {
    "id": "de712465-3f84-467b-a3b7-dc68fe97feb4",
    "inquiryId": "69c7c7c1-0636-4ac8-b549-5d922d51137a",
    "guestProfileId": "812fbd7a-2693-4a67-af23-6d315bbdef80",
