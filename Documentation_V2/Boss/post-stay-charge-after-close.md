...
- **Source report**: `Documentation_V2/test/E2E-post-stay-charge-after-close.no-db.md`
- **Scenario title**: E2E post-stay charge after close (S1 → S9 + post-closure charge) — no DB diffs
- **Goal**: Validate adding a post-stay charge after entry is closed at S9 (L2 authority).
...
- **Goal**: Execute `PATCH` `/availability/configurations/3ddc4976-fd4e-4819-90dc-513e1cc4c4c9/select` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/availability/configurations/3ddc4976-fd4e-4819-90dc-513e1cc4c4c9/select",
  "body": {
    "roomId": "9c09867b-2900-4e00-8b9a-0b24d21e814c"
  }
}
...
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/progress-stage` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/progress-stage",
  "body": {
    "targetStage": "S2",
    "version": 1
  }
...
### S2 create quotation
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/quotations` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/quotations",
  "body": {
    "nightlyRate": 100,
    "currency": "BTN",
    "notes": "quote"
...
### S2 send quotation
- **Goal**: Execute `POST` `/quotations/7d0b4ab9-134f-4f26-8a24-3b74ff916b9c/send` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/quotations/7d0b4ab9-134f-4f26-8a24-3b74ff916b9c/send",
  "body": {
    "id": "7d0b4ab9-134f-4f26-8a24-3b74ff916b9c",
    "entryId": "0168f693-649e-4970-a2e8-beeb30ae497f",
    "segmentId": "2ba27a05-28a7-4dd2-8b1b-290e96b0161d",
...
### S2 accept quotation
- **Goal**: Execute `POST` `/quotations/7d0b4ab9-134f-4f26-8a24-3b74ff916b9c/accept` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/quotations/7d0b4ab9-134f-4f26-8a24-3b74ff916b9c/accept",
  "body": {
    "id": "7d0b4ab9-134f-4f26-8a24-3b74ff916b9c",
    "entryId": "0168f693-649e-4970-a2e8-beeb30ae497f",
    "segmentId": "2ba27a05-28a7-4dd2-8b1b-290e96b0161d",
...
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/folio/provisional` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/folio/provisional",
  "body": {
...
- **Goal**: Execute `POST` `/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/payments` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/payments",
  "body": {
    "entryId": "0168f693-649e-4970-a2e8-beeb30ae497f",
    "amount": 500,
    "notes": "advance"
...
- **Goal**: Execute `POST` `/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/advance-payment/reconcile` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/advance-payment/reconcile",
  "body": {
    "entryId": "0168f693-649e-4970-a2e8-beeb30ae497f",
    "note": "reconcile"
  }
...
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/disclosures/cancellation` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/disclosures/cancellation",
  "body": {
...
### S3 committed hold
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/holds/committed` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/holds/committed",
  "body": {
    "roomId": "9c09867b-2900-4e00-8b9a-0b24d21e814c",
...
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/confirm` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/confirm",
  "body": {
    "version": 3
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/08e5dffc-6a19-439e-9339-03ac0ceece14` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/08e5dffc-6a19-439e-9339-03ac0ceece14",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/61dbbfca-81b3-4f0d-b8f6-cafa1d23faf6` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/61dbbfca-81b3-4f0d-b8f6-cafa1d23faf6",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/13205e78-5553-461b-9b95-e540895fde01` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/13205e78-5553-461b-9b95-e540895fde01",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/41b001fa-7d22-4373-a4b7-da38cb9a25ed` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/41b001fa-7d22-4373-a4b7-da38cb9a25ed",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/97476ef7-cb74-4b28-af5d-5cac8b380200` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/97476ef7-cb74-4b28-af5d-5cac8b380200",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/8a0eb399-20be-49ff-a91e-82917407e891` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/8a0eb399-20be-49ff-a91e-82917407e891",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/500289b5-79ff-413c-b7d1-1bbde295624d` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/500289b5-79ff-413c-b7d1-1bbde295624d",
  "body": {
    "action": "COMPLETE"
  }
}
...
- **Goal**: Execute `PATCH` `/pre-arrival-tasks/9e5e9c92-37b2-4f67-ad4b-3a4497db51f7` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "PATCH",
  "path": "/pre-arrival-tasks/9e5e9c92-37b2-4f67-ad4b-3a4497db51f7",
  "body": {
    "action": "COMPLETE"
  }
}
...
### S5 room assignment
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/room-assignments` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/room-assignments",
  "body": {
    "roomId": "9c09867b-2900-4e00-8b9a-0b24d21e814c",
    "notes": "assign"
  }
...
### S5 accept H1
- **Goal**: Execute `POST` `/handoffs/8dc19148-a30f-4023-b12d-c0bc8f09fa03/accept` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/handoffs/8dc19148-a30f-4023-b12d-c0bc8f09fa03/accept",
  "body": {
    "checklistCompletion": {
...
### S5 fulfil H1
- **Goal**: Execute `POST` `/handoffs/8dc19148-a30f-4023-b12d-c0bc8f09fa03/fulfil` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/handoffs/8dc19148-a30f-4023-b12d-c0bc8f09fa03/fulfil",
  "body": {
    "fulfilmentEvidence": {
...
### S6 create H2
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/handoffs/h2` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/handoffs/h2",
  "body": {
    "roomNumber": "401",
    "guestProfileId": "99758de0-530b-4f30-871e-c72bf1a36c79",
    "deficientConditionStatus": null
...
- **Goal**: Execute `POST` `/guest-profiles/99758de0-530b-4f30-871e-c72bf1a36c79/verify-identity` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/guest-profiles/99758de0-530b-4f30-871e-c72bf1a36c79/verify-identity",
  "body": {
    "entryId": "0168f693-649e-4970-a2e8-beeb30ae497f",
...
### S7 initiate H4
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/handoffs/h4` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/handoffs/h4",
  "body": {
    "notes": "h4"
  }
}
...
### S8 key return
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/key-return` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/key-return",
  "body": {
    "keyCountReturned": 2
  }
}
...
### S8 inspection
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/room-inspection` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/room-inspection",
  "body": {
    "isDeferred": false,
...
### S8 fulfil H4
- **Goal**: Execute `POST` `/handoffs/88e5bf0f-c04b-4041-9606-c8122b83125c/fulfil` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/handoffs/88e5bf0f-c04b-4041-9606-c8122b83125c/fulfil",
  "body": {
    "fulfilmentEvidence": {
...
### S8 settle CASH
- **Goal**: Execute `POST` `/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/settle` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/settle",
  "body": {
...
### S9 list invoices
- **Goal**: Execute `GET` `/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/invoices` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "GET",
  "path": "/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/invoices",
  "body": [
    {
      "id": "1f898d27-930a-4d9f-9890-a4f1e7de2fd6",
      "folioId": "3e6076f0-cfb7-445b-8479-6d0c6c060289",
...
- **Goal**: Execute `POST` `/invoices/1f898d27-930a-4d9f-9890-a4f1e7de2fd6/dispatch` and advance scenario state.
- **Request**: actor `L1`/`e2e-fd-7`

```json
{
  "method": "POST",
  "path": "/invoices/1f898d27-930a-4d9f-9890-a4f1e7de2fd6/dispatch",
  "body": {
...
### S9 close entry
- **Goal**: Execute `POST` `/entries/0168f693-649e-4970-a2e8-beeb30ae497f/close` and advance scenario state.
- **Request**: actor `L2`/`e2e-fom-7`

```json
{
  "method": "POST",
  "path": "/entries/0168f693-649e-4970-a2e8-beeb30ae497f/close",
  "body": {
    "id": "0168f693-649e-4970-a2e8-beeb30ae497f",
    "inquiryId": "3de2965a-0915-46ae-918a-07b24b835c63",
    "guestProfileId": "99758de0-530b-4f30-871e-c72bf1a36c79",
...
- **Goal**: Execute `POST` `/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/charges` and advance scenario state.
- **Request**: actor `L2`/`e2e-fom-7`

```json
{
  "method": "POST",
  "path": "/folios/3e6076f0-cfb7-445b-8479-6d0c6c060289/charges",
  "body": {
    "entryId": "0168f693-649e-4970-a2e8-beeb30ae497f",
    "lineType": "OTHER",
