...
export function DeskNewInquiryForm() {
  ...
  if (wizardStep === "type") {
    return (
      <section className="view">
        <Link className="ws-back" href="/bookings" style={{ marginBottom: 12, display: "inline-flex" }}>
          <ChevronLeft />
          Bookings
        </Link>
        ...
        <p className="lead">
          ...
          with the booking from the first step all the way through.
        </p>
  ...
  return (
    <section className="view">
      {isEdit ? (
        <Link className="ws-back" href={`/bookings/${editEntryId}`} style={{ marginBottom: 12, display: "inline-flex" }}>
          <ChevronLeft />
          Booking
        </Link>
      ) : (
