...
| Declared sources | DEV-SPEC-001_ToC_FINAL.md (Part 7 content requirements); DEV-SPEC-001-Part2.md (LOCKED — primary and nearly exclusive source; all 76 Prisma models); DEV-SPEC-001-Part6.md (LOCKED — service access patterns from which query specifications are derived) |
...
| Model count | 76 (matching the 76 @@map tables confirmed in Part 2) |
...
One entry per schema table. 76 entries total, matching the 76 `@@map` tables confirmed in Part 2. Entries are ordered by Part 2 section to support systematic verification.
...
**Step 2 — Count models.** Count model entries in §7.2. Target: 76. Any deviation from 76 is a finding.
