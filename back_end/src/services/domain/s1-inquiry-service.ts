...
export async function createInquiry(
  ...
  input: {
    ...
    /**
     * Which negotiated package this booking is quoted on (2026-08-04). Optional: when omitted,
     * pricing resolves the party's default package, then the COMMON one. Must belong to the
     * party named above — a package from a different agency would price the wrong rate.
     */
